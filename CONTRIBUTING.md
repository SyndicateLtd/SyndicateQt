Contributing to SYNX Core
============================

The SYNX Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/syndicate-project/syndicate/blob/master/doc/translation_process.md)
...
The following applies to code changes to the SYNX Core project, and is not to be
confused with overall SYNX Network Protocol consensus changes.

Whether a pull request is merged into SYNX Core rests with the project merge
...
Patches that change SYNX consensus rules are considerably more involved than
...
Where a patchset proposes to change the SYNX consensus, it must have been
...
The project leader is the release manager for each SYNX Core release.
