...
*Setup instructions for a gitian build of SYNX using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the SYNX
...
- [Building SYNX](#building-syndicate)
...
To build SYNX (for Linux, OSX and Windows) just follow the steps under 'perform
