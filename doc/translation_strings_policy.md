...
This document provides guidelines for internationalization of the SYNX Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to SYNX network</numerusform>
            <numerusform>%n active connections to SYNX network</numerusform>
        </translation>
    </message>
