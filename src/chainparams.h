 ...
 * SYNX system. There are three: the main network on which people trade goods
...
public:
    ...
    int SyndicateBadBlockTime() const { return nSyndicateBadBlockTime; }
    int SyndicateBadBlocknBits() const { return nSyndicateBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nSyndicateBadBlockTime;
    unsigned int nSyndicateBadBlocknBits;
